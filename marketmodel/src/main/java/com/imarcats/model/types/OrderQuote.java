...
public class OrderQuote implements MarketModelObject {
	...
	public OrderQuote(Quote quote_) {
		super();
		_quote = quote_;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrderQuote other = (OrderQuote) obj;
		if (_id == null) {
			if (other._id != null)
				return false;
	...
	public String toString() {
		return "OrderQuote [_id=" + _id + ", _quote=" + _quote + "]";
	}
}	