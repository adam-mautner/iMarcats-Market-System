 ...
 * @author Adam
 */
public class BuyBookDto implements OrderBookModelDto {
	 ...
	 */	
	private List<BuyOrderBookEntryDto> _orderBookEntries = new ArrayList<BuyOrderBookEntryDto>();
	...
	public List<BuyOrderBookEntryDto> getOrderBookEntries() {
		return _orderBookEntries;
	}

	public void setOrderBookEntries(List<BuyOrderBookEntryDto> orderBookEntries_) {
