 ...
 */
@Entity
@Table(name="LIMIT_QUOTE")
public class LimitQuote implements MarketModelObject {
	...
	public LimitQuote(Quote quote_) {
		super();
		_quote = quote_;
	}
	...
	public String toString() {
		return "LimitQuote [_id=" + _id + ", _quote=" + _quote + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LimitQuote other = (LimitQuote) obj;
		if (_id == null) {
			if (other._id != null)
				return false;
