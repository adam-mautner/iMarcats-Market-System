 ...
 */
@Entity
@Table(name="TRADE_QUOTE")
public class TradeQuote implements MarketModelObject {
	...
	public TradeQuote(Quote quote_) {
		super();
		_quote = quote_;
	}
	...
	public String toString() {
		return "TradeQuote [_id=" + _id + ", _quote=" + _quote + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TradeQuote other = (TradeQuote) obj;
		if (_id == null) {
			if (other._id != null)
				return false;
